export default {
    firstTitle: 'Conheça a Autora',
    secondTitle: 'Minha Amada Igreja',
    firstParagraph: `<span style="font-family:vivaldi;font-size:40pt;color:#F00">S</span>
    <span class="font-weight-bold">eu nome de nascimento:</span>
    ...
    secondParagraph: `<span class="font-weight-bold">Tempo difíceis:</span> Divorciada e com 04 filhos para criar...
    Só Jesus na direção.<br />
    ...
    <span class="font-projeto">“Um por todos! Todos por um”</span>
    ...
    – Pastor Aldo, Ronaldo e Pastor Sergio.<br />
