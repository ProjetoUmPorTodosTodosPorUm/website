...
const pt_BR_how_to_participate_component = {
    callToAction: {
        text: "você quer participar? Entraremos em contato!",
        nameInput: 'Nome',
        emailInput: 'E-mail',
        button: 'Eu quero fazer parte disso!'
    },
    headline: 'Como Uma Família Pode Participar?',
    firstParagraph: `É muito simples participar. Verifique no link <a href="/onde-atuamos">ONDE ATUAMOS</a> deste
    ...
    secondParagraph: `No ato de sua inscrição a família voluntária ofertante deverá assinar um documento onde
...
export default pt_BR_how_to_participate_component